...
" Name:       phallus.vim
" Version:    1.0
" Maintainer: https://github.com/stelgard/phallus.vim/
" License:    The MIT License (MIT)
" Based On:   https://github.com/phallus/arch-files/blob/master/config/.vimrc
...
if !exists("g:phallus_termcolors")
  let g:phallus_termcolors = 256
endif

" Mot all terminals support italics properly. If yours does, opt-in.
if !exists("g:phallus_terminal_italics")
  let g:phallus_terminal_italics = 0
endif
...
function! s:h(group, style)
  if g:phallus_terminal_italics == 0 && has_key(a:style, "cterm") && a:style["cterm"] == "italic"
    unlet a:style.cterm
  endif
  if g:phallus_termcolors == 16
...
let s:red = { "gui": "#CE4A6A", "cterm": "167", "cterm16": "1"} " Alternate cterm: 168
"let s:dark_red = { "gui": "#e64040", "cterm": "196", "cterm16": "9"}

let s:green = { "gui": "#A1A97F", "cterm": "144", "cterm16": "2"}
"let s:dark_green = { "gui": "#6dc35c", "cterm": "36", "cterm16": "10"}

let s:yellow = { "gui": "#9A7EAA", "cterm": "103", "cterm16": "3"}
let s:dark_yellow = { "gui": "#BEA5CD", "cterm": "146", "cterm16": "11"}

let s:blue = { "gui": "#647391", "cterm": "66", "cterm16": "4"} " Alternate cterm: 75
"let s:dark_blue = { "gui": "#6097dc", "cterm": "32", "cterm16": "12"}

let s:purple = { "gui": "#9A73B3", "cterm": "103", "cterm16": "5"} " Alternate cterm: 176
"let s:dark_purple = { "gui": "#8d73de", "cterm": "55", "cterm16": "13"}

let s:cyan = { "gui": "#70918C", "cterm": "66", "cterm16": "6"} " Alternate cterm: 73
